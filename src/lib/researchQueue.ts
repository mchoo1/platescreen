...
export const RESEARCH_QUEUE = [
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Tanglin Halt Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-19 (scheduled restaurant-track run, first individual attempt on this entry — earlier passes only spot-checked sibling task #29 bucket members): picked deterministically per Phase 1 after re-confirming the queue's top three high-priority entries (kopitiam, koufu, foodfare) and the medium-priority hawkers_street entry have no actionable single-outlet menu-research work this run (kopitiam's 3 remaining sub-brands are blocked on Street View/a Brand-merge restructure per that entry's own notes; koufu's remaining leads are 403'd/JS-locked; foodfare is user-deprioritized; hawkers_street's own MenuItems backlog is now fully covered — verified via direct brands.ts/menuItems.ts check, all 37 operatorId:'hawkers_street' brands have ≥1 MenuItem — its remaining work is Premises-only, out of this run's menu-research scope) — then swept forward to the first pending hawker/food_court/etc. entry with genuine unattempted per-outlet work. This session's Browser pane (mcp__Claude_Browser__*) was tested directly before falling back to WebSearch: request_access for google.com was declined at the tool level in this unattended session, consistent with the browser-blocking pattern documented on every prior scheduled run for this queue. Ran 2 WebSearch queries ('\"Lim Hang Tong\" Tanglin Halt Market stall' and a general venue-stalls query) plus direct fetches of eatshopplay.sg's venue listing (address/hours only, no per-stall directory), hawkerpedia.com.sg's 10-must-try-stalls guide, and eatbook.sg's 8-stalls guide — combined, these sources name 18 distinct Tanglin Halt stalls (Wei Yi Laksa & Prawn Noodle, Tanglin Halt Original Peanut Pancake, Delicious Duck Noodles, Mei Wei Xiao Chi, Jiu Ye, Ah Luck Bean Curd, Guangzhou Mian Shi Wanton Noodle, Mei Jia Fried Bee Hoon, Lao Cai Shi Minced Meat Noodles, Edmond Chicken Rice, Chef Hainanese Western Food, Queenstown Lontong, Jing Shu Shi Curry Rice, Alimah's Kitchen, No.1 Western Food, Tong Kee Chicken Rice, Tian Xiang Wanton Mee, Hakka Thunder Tea Rice) and none is named 'Lim Hang Tong'. Consistent with the established task #29 finding (bare SFA-licensee personal name that never appeared on any signboard — text search cannot resolve it; only Street View or an in-person visit can). Did not fabricate a menu. No Brand/Premises/MenuItem files touched. No fallback outlet picked in the same run, per Phase 2 step 5. Status left 'pending'. See reference/research-sessions/2026-09-19-tanglin_halt_market_lim_hang_tong.md."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Kukoh 21 Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-19 (scheduled restaurant-track run, first individual attempt on this entry): after re-confirming the queue's top priority entries (kopitiam/koufu/foodfare/hawkers_street) and the already-exhausted 2026-09-02/09-19 personal-name task #29 bucket entries earlier in the medium-priority block have no actionable single-outlet work this run, picked this as the first genuinely fresh candidate (only generic boilerplate notes, never individually researched). Browser pane request_access for google.com was declined at the tool level (unattended session), consistent with every prior scheduled run against this queue. Ran WebSearch for '\"Kukoh 21\" food centre NTUC Foodfare stall' and 'Kukoh 21 Food Centre stalls list hawker' plus a direct fetch of eatshopplay.sg's venue listing and a search for '\"Foodfare\" Jalan Kukoh coffee shop OR canteen' — multiple sources name specific stalls at this centre (Ri Tao Fu Teochew Pig's Organ Soup, Jalan Kukoh Teochew Kueh, The $2.50 Shop, Midas roti prata, Ke Jia Yong Tau Hu, CSB Seafood/Fish Soup, Maria Qi Heng Coffee, Coffee Aroma, Al-Mina Indian Food) but none names a stall trading as 'NTUC Foodfare' or 'Foodfare'. Fetched foodfare.com.sg directly: the co-operative's current public positioning (as of this run) is exclusively B2B institutional catering (childcare/healthcare/government/SAF/MHA) with no consumer-facing hawker stalls or coffee shops mentioned anywhere on the site — consistent with this project's existing brands.ts header note that 'NTUC Foodfare's own site now positions it purely as B2B institutional catering, not public food courts.' This SFA licence (JK10107004) is almost certainly a legacy holding from an earlier era when the co-operative ran public-facing coffee shops/canteens, but there is no discoverable current source naming what specific dish or stall it corresponds to today. Same class of problem as the bare-personal-name task #29 bucket (a registered licensee name that never appeared on any signboard), just for a corporate/institutional entity instead of an individual — text search cannot resolve it; only Street View or an in-person visit could confirm what's actually being sold at this unit. Did not fabricate a menu. No Brand/Premises/MenuItem records touched. Did not pick a fallback outlet in the same run, per Phase 2 step 5. Status left 'pending'. Note: the sibling entry `telok_blangah_market_ntuc_foodfare_co_operative_ltd` shares this exact same corporate-licensee finding (same institutional entity, different venue) but was not individually verified this run — flagged for whoever picks it up next rather than assumed. See reference/research-sessions/2026-09-19-kukoh_21_food_centre_ntuc_foodfare_co_operative_ltd.md."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Yuhua Village Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Tampines Round Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this SFA licence (S84212A000) is a KFC outlet, not an independent stall — a Premises row already exists (kfc_p1196, brandId: 'kfc', exact same licence/address/grade) and the 'kfc' Brand already carries a full generic MenuItems menu (11 items). Stale note pre-dates the 2026-08-20 Brand/Premises/MenuItem restructure (referred to 'Outlet'/'FoodOption'). Flipped to 'researched' — no new records needed, this location is already fully covered under the shared 'kfc' Brand."
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this SFA licence (S94171C000) is a Pizza Hut outlet, not an independent stall — a Premises row already exists (pizza_hut_p1259, brandId: 'pizza_hut', exact same licence) and the 'pizza_hut' Brand already carries a full generic MenuItems menu (12 items). Stale note pre-dates the 2026-08-20 Brand/Premises/MenuItem restructure. Flipped to 'researched' — no new records needed, this location is already fully covered under the shared 'pizza_hut' Brand."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Teban Gardens Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Toa Payoh West Market and Food Court) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, checked not selected): considered as a candidate since 'Chang Cheng' is a real, well-documented 160+ shop Singapore mixed-vegetable-rice/zi-char chain (changcheng.sg) that originated at Toa Payoh Blk 126, very close to this premises. However, sgpbusiness.com/opengovsg confirm 'Chang Cheng Food Paradise Pte. Ltd.' (UEN 200903588C)'s principal SSIC activity is 'Food courts, coffee shops and canteens (with mainly food and beverage income)' — a food-court-OPERATOR company, not a single dish-stall — the same container-brand risk already flagged in CLAUDE.md §4.3 and on the sibling clementi_west_street_2...new_century_food_house_721 entry's 2026-09-05 note. Assigning a MenuItem here risks misrepresenting an entire multi-stall coffeeshop/food-court as one dish concept. Not selected this run; flagged for the same future pass that needs to resolve whether this Premises row is one internal stall or the whole venue before any macro research proceeds."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Toa Payoh Lorong 4 Blk 93) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'mcd' chain Brand (56 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Toa Payoh Lorong 4 Blk 93) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'pizza_hut' chain Brand (12 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Chong Boon Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cheers' chain Brand (6 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Chong Boon Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    status: "researched",
    sfaLicenceNo: "B01026K000",
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Cheng San Market and Cooked Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cheers' chain Brand (6 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    status: "researched",
    sfaLicenceNo: "S84202V000",
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Cheng San Market and Cooked Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Mayflower Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Mayflower Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'mcd' chain Brand (56 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    status: "researched",
    sfaLicenceNo: "B00030C000",
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Ang Mo Kio 628 Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    status: "researched",
    sfaLicenceNo: "B81055C000",
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Ang Mo Kio 628 Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'mcd' chain Brand (56 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Blk 724 Ang Mo Kio Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Kaki Bukit 511 Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    status: "researched",
    sfaLicenceNo: "SE10593N000",
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Bedok North Street 3 Blk 538) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Clementi West Street 2 Blk 726) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Kovan Hougang Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run): this run's single-outlet research target — 'Alpha Subs' is a plausible real trading name (sandwich/sub concept), unlike the bare-personal-name task #29 bucket, so worth a genuine attempt. This Brand's own SFA premisesAddress ('BLK 205 HOUGANG STREET 21 HEARTLAND MALL- KOVAN', Blk 205) is actually Heartland Mall, distinct from the Kovan Hougang Market and Food Centre address (Blk 209) carried on its locationContext/label — likely a mall F&B kiosk, not a hawker stall proper. Multiple WebSearches ('Alpha Subs' + Kovan/Heartland Mall/Singapore/sandwich, foodpanda/Burpple/DanielFoodDiary/Eatbook site searches) found no menu, review, or listing under this name — only the bare ACRA/JobStreet corporate registration (200902519G, registered address unrelated at The Interlace) with no business-activity/menu detail retrievable (opengovsg.com and jobstreet.com both returned JS-rendered empty content via web_fetch). Heartland Mall's own mall-directory/F&B pages were not directly fetchable (not surfaced via WebSearch results, so out of web_fetch provenance). Did not fabricate a menu. Status left 'pending' — needs a rendered-browser visit to heartlandmall.com.sg's F&B directory or Google Maps/Street View (same class of blocker as the kopitiam_china_food entry) to confirm what this unit actually sells."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Kovan Hougang Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'breadtalk' chain Brand (6 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Kovan Hougang Market and Food Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Hougang 105 Hainanese Village Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'bengawan_solo' chain Brand (8 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this SFA licence (NE12G58B000) is a BreadTalk outlet, not an independent stall — a Premises row already exists (breadtalk_p1107, brandId: 'breadtalk', exact same licence) and the 'breadtalk' Brand already carries a generic MenuItems menu (6 items). Stale note pre-dates the 2026-08-20 Brand/Premises/MenuItem restructure. Flipped to 'researched' — no new records needed, this location is already fully covered under the shared 'breadtalk' Brand."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Jurong West Hawker Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
  ...
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, picked as this run's single-outlet target): the bare licensee name is a corporate registration, not the real trading name — confirmed via data.gov.sg's live SFA API (licence E75024N002 -> premises_address '212 LORONG 8 TOA PAYOH #01-53 SINGAPORE 310212', grade A) and independent WebSearch that this is 'Lee Kwang Kee Teochew Cuisine', a real, well-documented Chinese Teochew restaurant (est. Sept 2014, official site teochew-cuisine.com, own Facebook page, Burpple/Tripadvisor/Lemon8/blog coverage) - note this Brand's own Premises row's 'address'/'locationContext' fields still say the food centre's generic 'Blk 210' label while the SFA-verified premisesAddress is actually Blk 212 next door (pre-existing Premises data, out of this run's write scope, flagged here for a future Premises-accuracy pass rather than corrected). Added 10 real MenuItems (lkk_har_gow through lkk_yam_paste_pumpkin_gingko: Har Gow, Xiao Long Bao, Siew Mai, Steamed Shrimp Beancurd Skin Roll, Steamed Pork Ribs Black Bean Sauce, Pan-Fried Yam Cake, Teochew Fried Oyster Omelette, Sweet & Sour Sliced Garoupa Fish, Teochew Cold Crab, Yam Paste With Pumpkin & Gingko Nuts), all confidence 'estimated' (real dish names + prices sourced from ivanteh-runningman.blogspot.com's photographed-menu review since the restaurant's own official menu is an unparsable image scan; macros calibrated against this DB's own existing dim sum/oyster omelette/steamed fish/chilli crab entries — see menuItems.ts's comment block above the lkk_ entries for full reasoning). Also did a systematic bookkeeping sweep of this batch's ~38 sibling bare-SFA-licensee entries this run: 6 turned out to be chain-duplicates already covered under an existing shared Brand (kfc/pizza_hut/breadtalk/dominos/mcd) and 2 already had real MenuItems from earlier untracked work — all 8 flipped to 'researched' on their own entries (see each entry's own 2026-09-18 note); the remaining ~29 (mostly genuine bare-personal-name task #29 entries, plus toa_payoh_west_market_and_food_court_chang_cheng_food_paradise_pte_ltd and clementi_west_street_2_blk_726_new_century_food_house_721_pte_ltd which are food-court-operator containers, and kovan_hougang_market_and_food_centre_alpha_subs_pte_ltd already re-attempted this same day's earlier run with no source found) were left untouched, not independently re-verified this pass. See reference/research-sessions/2026-09-18-lee_kwang_kee_teochew_cuisine.md."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Ayer Rajah Market) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this SFA licence (SW11864P000) is a Domino's outlet, not an independent stall — a Premises row already exists (dominos_p1446, brandId: 'dominos', exact same licence) and the 'dominos' Brand already carries a full generic MenuItems menu (13 items). Stale note pre-dates the 2026-08-20 Brand/Premises/MenuItem restructure. Flipped to 'researched' — no new records needed, this location is already fully covered under the shared 'dominos' Brand."
  },
  {
  ...
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this queue entry is fully stale — its own duplicate Brand row was already removed on 2026-08-24 (Batch L) and reassigned as a Premises row (mcd_anchorvale_village_hawker_centre, same licence CE09078N000) under the existing 'mcd' Brand, which already carries a full generic MenuItems menu (56 items) — see brands.ts's 2026-08-24 Batch L note. Flipped to 'researched' — no new records needed, this location has been covered under 'mcd' for weeks."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: One Punggol Hawker Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
    ...
    notes: "UPDATE 2026-09-18 (scheduled restaurant-track run, bookkeeping fix): this Brand already has real MenuItems in the live menuItems.ts (checked directly, not just a stale scan) — Phase 2/4 research on this entry is already complete from an earlier untracked pass. Stale 'pending' status pre-dates that work. Flipped to 'researched' as a verified bookkeeping fix, no new records added this run."
  },
  {
    ...
    notes: "Outlet row already exists (added in the 2026-08-20 SFA hawker restructuring, location: Punggol Coast Hawker Centre) — only menu items/macros (FoodOption records) are needed, not a new Outlet. UPDATE 2026-09-18 (scheduled restaurant-track run, staleness audit): status was stale — this entry's Premises row already links to the existing 'cold_storage' chain Brand (5 real MenuItems), the standard shared-chain-Brand pattern, rather than a separate single-item Brand under this entry's own id. No new Brand/MenuItem needed or added. Flipping to 'researched' as a bookkeeping fix; found during a systematic staleness sweep of this batch's remaining pending entries after re-confirming kopitiam/koufu/foodfare/hawkers_street have no addressable single-outlet gap this run (per the 2026-09-17 note)."
  },
  {
